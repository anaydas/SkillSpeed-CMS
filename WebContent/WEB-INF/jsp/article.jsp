...
<body>
<form:form action="/article/addComment/${articleId}" commandName="comments" method="POST">
<h1 align="center">${articleName}</h1><br>
	...
	<table>
		<c:forEach items="${listOfComment}" var="commentList">	
		<tr>
			<td>${commentList.commentDetails}</td>
		</tr>
		</c:forEach>
	</table>
